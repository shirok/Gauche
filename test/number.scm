...
(let ((wc (make-write-controls :exact-decimal #t)))
  ...
  (t 1/7 "#e0.#142857")
  (t -1/7 "#e-0.#142857")
  (t 4/1300 "#e0.00#307692")
  (t -1234/51 "#e-24.#1960784313725490")
  (t 1/1151 "#e0.#")
  (t 1/2063 "1/2063") ; it has repeating cycle of 1031 digits, so we give up.
  )
...
;; Precision
(dolist [n '((0.123456789 "0.12346" "0.1235" "0.123" "0.12" "0.1" "0.")
             (1.23456789 "1.23457" "1.2346" "1.235" "1.23" "1.2" "1.")
             (12.3456789 "12.34568" "12.3457" "12.346" "12.35" "12.3" "12.")
             (-123.456789 "-123.45679" "-123.4568" "-123.457"
                          "-123.46" "-123.5" "-123.")
             (1.23456789e100 "1.23457e100" "1.2346e100" "1.235e100"
                             "1.23e100" "1.2e100" "1.e100")
             (12.3456789e-101 "1.23457e-100" "1.2346e-100" "1.235e-100"
                              "1.23e-100" "1.2e-100" "1.e-100")
             (1. "1.00000" "1.0000" "1.000" "1.00" "1.0" "1.")
             (1.1 "1.10000" "1.1000" "1.100" "1.10" "1.1" "1.")
             (1e100 "1.00000e100" "1.0000e100" "1.000e100"
                    "1.00e100" "1.0e100" "1.e100"))]
  (define (runs flags)
...
(dolist [data '((1.99999 (5 4 3 2 1) ("1.99999" "2.0000" "2.000" "2.00" "2.0"))
                ...
                ;(0.25 (1) ("0.2")) ; if we use banker's rounding
                (0.25 (1) ("0.3")) ; if we use commercial rounding
                (0.135 (2) ("0.14")))]
...
(test* "ratnum->flonum issue #981"
       1.8359300949164161
       (inexact ))
...
;; https://github.com/shirok/Gauche/issues/980
(test* "log bignum precision"
       842.7813755971428
       (log ))
