...
(let ([data '((#f . 3428989595)
              ...
              (1 . 387276917)
              (-1 . 626627309)
              (45174651375937459317569347657 . 3238994630)
              (1.1 . 2919879337)
              (-1.1 . 1375087959)
              (3.767278962604361e-10 . 0)
              (3.767278962604362e-10 . 1) ; NB: with old code, this was 0 on 8087
              (3.767278962604363e-10 . 1)
              (-3.767278962604361e-10 . 0)
              (-3.767278962604362e-10 . 4294967295) ; NB: with old code, this was 0 on 8087
              (-3.767278962604363e-10 . 4294967295)
              (3474701543.0 . 1981271040) ; NB: with old code, this was 1981270711 on 8087
              (3474701544.0 . 0)
              (-3474701544.0 . 0)
              (+inf.0 . 0)
              (+nan.0 . 0)
              ...
              (abc . 96354)
              (:foo . 101574))])
  (test* "portable hash" data
         (map (^p (cons (car p) (portable-hash (car p)))) data)))
