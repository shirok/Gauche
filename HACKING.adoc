...
Contributions are welcome.  Preferred way is through GitHub pull requests.
We'd line one PR to solve one issue (or tightly related issues).
...
follow the original license and credit the original author.

We don't mind you use tools such as LLMs.  After all, it is _you_
who take responsibility of the quality of the code.
