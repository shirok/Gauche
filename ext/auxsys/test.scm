...
(test* "fmod" 0.25 (fmod 5.25 1) nearly=)
(test* "fmod" 2.3  (fmod 8.3 3)  nearly=)
(test* "fmod" 8.3  (fmod 8.3 33) nearly=)

(test* "frexp" '(0.785 2) (values->list (frexp 3.14)) nearly=)

(test* "ldexp" 3.14 (ldexp 0.785 2) nearly=)

(test* "modf" '(0.14 3.0) (values->list (modf 3.14)) nearly=)
