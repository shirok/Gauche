...
# Generate uvector.h
#
#  $Id: uvector.h.sh,v 1.18 2002-10-14 20:58:17 shirok Exp $
#
...
extern ScmObj Scm_Int64Box(ScmInt64 v);
extern ScmObj Scm_Uint64Box(ScmInt64 v);
extern ScmInt64 Scm_Int64Unbox(ScmObj o, int clamp);
extern ScmInt64 Scm_Uint64Unbox(ScmObj o, int clamp);
#endif /* SIZEOF_LONG == 4 */
...
#else
typedef ScmInt64     SCM_UVECTOR_INT64;
typedef ScmInt64     SCM_UVECTOR_UINT64;
#endif
