...
(define *te-samples*
  '(;;mode  dir ucs4     utf8                         utf16
    ...
    (spi =  #x81      (#xc2 #x81)                  (#x81))
    (spi =  #xff      (#xc3 #xbf)                  (#xff))
    (spi =  #x100     (#xc4 #x80)                  (#x100))
    (spi =  #x7ff     (#xdf #xbf)                  (#x7ff))
    (spi =  #x800     (#xe0 #xa0 #x80)             (#x800))
    (spi =  #xd7ff    (#xed #x9f #xbf)             (#xd7ff))
    ...
    (spi =  #xe000    (#xee #x80 #x80)             (#xe000))
    (spi =  #xffff    (#xef #xbf #xbf)             (#xffff))
    (spi =  #x10000   (#xf0 #x90 #x80 #x80)        (#xd800 #xdc00))
    (spi =  #x103ff   (#xf0 #x90 #x8f #xbf)        (#xd800 #xdfff))
    (spi =  #x10400   (#xf0 #x90 #x90 #x80)        (#xd801 #xdc00))
    (spi =  #x50000   (#xf1 #x90 #x80 #x80)        (#xd900 #xdc00))
    (spi =  #x10ffff  (#xf4 #x8f #xbf #xbf)        (#xdbff #xdfff))
