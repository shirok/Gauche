...
(t-subtype <c-fixnum> <c-fixnum> #t)
(t-subtype <c-fixnum> <integer> #t)
(t-subtype <c-fixnum> <real> #t)
(t-subtype <c-fixnum> <number> #t)
(t-subtype <c-fixnum> <top> #t)
(t-subtype <bottom>   <c-fixnum> #t)
(t-subtype <c-fixnum> <boolean> #f)
(t-subtype <c-short>  <integer> #t)
(t-subtype <c-ushort> <integer> #t)
(t-subtype <c-int>    <integer> #t)
(t-subtype <c-uint>   <integer> #t)
(t-subtype <c-long>   <integer> #t)
(t-subtype <c-ulong>  <integer> #t)
(t-subtype <c-int8>   <integer> #t)
(t-subtype <c-uint8>  <integer> #t)
(t-subtype <c-int16>  <integer> #t)
(t-subtype <c-uint16> <integer> #t)
(t-subtype <c-int32>  <integer> #t)
(t-subtype <c-uint32> <integer> #t)
(t-subtype <c-int64>  <integer> #t)
(t-subtype <c-uint64> <integer> #t)
(t-subtype <c-float>  <integer> #f)
(t-subtype <c-float>  <real>    #t)
(t-subtype <c-float>  <number>  #t)
(t-subtype <c-double> <integer> #f)
(t-subtype <c-double> <real>    #t)
(t-subtype <c-double> <number>  #t)
(t-subtype <c-fixnum> <c-float> #f)
(t-subtype <number>   <c-fixnum> #f)
...
(t-subtype <c-int> (</> <c-int> <char>) #t)
(t-subtype <char> (</> <c-int> <char>) #t)
(t-subtype <c-int> (</> <integer> <char>) #t)
(t-subtype <integer> (</> <c-int> <char>) #f)
